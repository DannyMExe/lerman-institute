...
const publications = [
  ...
  },
  {
    ...
    author: "Lerman, Z.M.",
    publisher:
      "American Chemical Society, Washington, DC In Jobs, Collaborations, and Women Leaders in the Global Chemistry Enterprise; Wu, M.L.; Cheng, H.N.; Miller, B., Eds.",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "15th ISCB International Conference. ICCM 2011. Published in a book on: “Chemistry for Mankind: Innovative Ideas in the Life Sciences”",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "Studies in Philosophy, Culture & Education, (Institute for Multicultural Research, Arab Academic College for Education)",
  ...
  },
  {
    ...
    publisher:
      "Chemistry in Israel - Bulletin of the Israel Chemical Society, (21)",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "Chemistry in Israel - Bulletin of the Israel Chemical Society, (8)",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "Chemical Education Journal, 5, (1), Special Issue on Pacifichem 2000",
    pages: "(2001)",
    url: "",
  },
  {
  ...
  },
  {
    id: "23",
    title:
      "Jacket notes for: Giannini, A. J.: Drug Abuse: A Family Guide to Detection, Treatment and Education",
    author: "Lerman, Z.",
  ...
  },
  {
    id: "24",
    title:
      "From Ozone to Oil Spills: Incorporating Technology into the Classroom",
    author: "Lerman, Z. M.",
  ...
  },
  {
    id: "25",
    title:
      "Use of Gas Chromatography/Mass Spectroscopy in Non-Science Major Course Laboratory Experiments",
  ...
  },
  {
    id: "26",
    title:
      "The Art of Teaching Science: From Textbooks and Test Tubes to Drama and Dance",
    author: "Lerman, Z. M.",
    publisher:
      "Proceedings from the 14th International Conference on Chemical Education",
  ...
  },
  {
    id: "27",
    title:
      "Creative Methods of Teaching Chemistry in the Secondary School Level",
    author: "Lerman, Z. M.",
    publisher:
      "Chemistry: The Key To The Future: Proceedings from the 13th International Conference on Chemical Education",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "Proceedings of Human Resources in Science and Technology; Preparing for the 21st Century",
  ...
  },
  {
    id: "30",
    title:
      "Science Education to Students with Diverse Cultural Backgrounds and Diverse Academic Interests",
    author: "Lerman, Z. M., Adams, G. E., Papacosta, P., and Wade, J. S.",
    publisher:
      "Selected Papers of the IOSTE 5th Symposium on World Trends in Science and Technology Education",
  ...
  },
  {
    ...
    author: "Lerman, Z. M.",
    publisher:
      "1989 ICASE YEARBOOK, Proceedings of the ICASE World Conference: CONASTA 37 on Science Education and the Quality of Life, B. Honeyman, editor: ASTA and ICASE",
  ...
  },
  {
    id: "33",
    title:
      "Chemistry Without Tears: Teaching Chemistry Through Music, Drama, Art and Sports",
    author: "Lerman, Z. M.",
    publisher:
      "Science Learning in the Informal Setting Symposium Proceedings, P. Heltne and L. Marquardt, editors: The Chicago Academy of Sciences",
    pages: "(Chicago: 1988)",
    url: "",
  },
  {
          ...
          <div key={publication.id} className={styles.list_item}>
            <p>
              ...
              {publication.url ? (
                ...
                >
                  <span className={styles.title}>{publication.title}</span>
                </a>
              ) : (
                <span className={styles.title}>{publication.title}</span>
              )}{" "}
              {publication.publisher} {publication.pages}
            </p>
          </div>
        ))}
      </div>
